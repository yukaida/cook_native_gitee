...
-keep class com.ebanswers.kitchendiary.mvp.model.**{*;}
-keep class com.ebanswers.kitchendiary.bean.*{*;}

-keepclassmembers class * {
  	 public <init>(org.json.JSONObject);
	}
-keep public class com.ebanswers.kitchendiary.R$*{
    		public static final int *;
    	}

#混淆model文件
 -keep class com.ebanswers.kitchendiary.mvp.model.* {*;}
 -keep class com.ebanswers.kitchendiary.network.response.* {*;}
...
# for DexGuard only 一种收费的混淆模式DexGuard
