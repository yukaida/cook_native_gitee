 ...
 * desc：更多精彩适配器
 */
public class CookBookAdapter extends BaseQuickAdapter<CookbookInfo, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, CookbookInfo item) {
        ...
        if (item.getThumbnail_url()!= null && !TextUtils.isEmpty(item.getThumbnail_url().get(0)/**/)){
