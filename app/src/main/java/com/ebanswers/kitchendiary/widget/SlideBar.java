...
public class SlideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        defaultColor = a.getColor(R.styleable.SlideBar_android_textColor, Color.GRAY);
        chooseColor = a.getColor(R.styleable.SlideBar_slideBar_chooseTextColor, Color.MAGENTA);
        chooseBackgroundColor = a.getColor(R.styleable.SlideBar_slideBar_chooseBackgroundColor, Color.TRANSPARENT);
