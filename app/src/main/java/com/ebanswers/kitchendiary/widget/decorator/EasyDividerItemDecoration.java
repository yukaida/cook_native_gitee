...
public class EasyDividerItemDecoration extends RecyclerView.ItemDecoration {
    private int verticalpaddingInPx;
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        final int left = parent.getPaddingLeft() + verticalpaddingInPx;
        final int right = parent.getWidth() - parent.getPaddingRight() - verticalpaddingInPx;
    ...
    public void setVerticalpaddingInPx(int padding){
        this.verticalpaddingInPx = padding;
    }
}
