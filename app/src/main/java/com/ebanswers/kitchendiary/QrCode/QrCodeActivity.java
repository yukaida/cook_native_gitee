package com.ebanswers.kitchendiary.QrCode;
...
import com.ebanswers.kitchendiary.QrCode.camera.CameraManager;
import com.ebanswers.kitchendiary.QrCode.decode.CaptureActivityHandler;
import com.ebanswers.kitchendiary.QrCode.decode.DecodeManager;
import com.ebanswers.kitchendiary.QrCode.decode.InactivityTimer;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private void initView() {
        ...
        TitleBar qrCodeHeaderBar = findViewById(R.id.qr_code_header_bar);
        ImmersionBar.setTitleBar(this,qrCodeHeaderBar);
        ...
        qrCodeHeaderBar.setOnTitleBarListener(new OnTitleBarListener() {
            @Override
...
//        initCamera();
    ...
    private void handleResult(String resultString) {
        if (TextUtils.isEmpty(resultString)) {
            ...
            LogUtils.i("位置信息：=====" + resultString);
        /*    Intent intent = new Intent(this, WeakElectricityRegisterActivity.class);
