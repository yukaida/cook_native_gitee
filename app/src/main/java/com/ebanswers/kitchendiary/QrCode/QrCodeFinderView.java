...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mFrameRect.left = (com.ebanswers.kitchendiary.utils.ScreenUtils.getScreenWidth() - layoutParams.width) / 2;
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        mPaint.setTextSize(getResources().getDimension(R.dimen.textsize_13));
        ...
        float left = (com.ebanswers.kitchendiary.utils.ScreenUtils.getScreenWidth() - mPaint.getTextSize() * text.length()) / 2;
